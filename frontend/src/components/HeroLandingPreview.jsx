      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#070B12]/70 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#C7A14A] to-[#F2D58A] p-[1px]">
            ...
            <div className="leading-tight">
              <div className="font-semibold tracking-wide">BookMyVenue</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-xl bg-[#C7A14A] px-4 py-2 text-sm font-semibold text-[#0B1220] hover:brightness-110">
              Get Expert Help
            </button>
          </div>
        </div>
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            {/* Subtle glow */}
            <div className="absolute -top-32 left-1/2 h-80 w-[46rem] -translate-x-1/2 rounded-full bg-[#C7A14A]/10 blur-3xl" />
          </div>
              ...
              {slides.map((s, idx) => (
                <button
                  ...
                  className={[
                    ...
                    idx === active
                      ? "border-[#C7A14A]/60 bg-[#C7A14A]/15 text-white"
                  ...
                  <form className="mt-5 space-y-3" onSubmit={handleSubmit}>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none placeholder:text-white/35 focus:border-[#C7A14A]/60"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none focus:border-[#C7A14A]/60"
                      >
                        {EVENT_TYPES.map((t) => (
                    ...
                    <button
                      type="submit"
                      className="group mt-2 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#C7A14A] px-4 py-3 text-sm font-semibold text-[#0B1220] hover:brightness-110"
                    >
