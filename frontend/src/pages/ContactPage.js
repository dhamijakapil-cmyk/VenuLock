  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#111111] mb-2" data-testid="contact-heading">Contact Us</h1>
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-12">
          <div className="bg-white rounded-xl border border-slate-200 p-6" data-testid="contact-email-card">
            <div className="w-10 h-10 rounded-lg bg-[#F5C84C]/10 flex items-center justify-center mb-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6" data-testid="contact-phone-card">
            <div className="w-10 h-10 rounded-lg bg-[#111111]/10 flex items-center justify-center mb-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6" data-testid="contact-whatsapp-card">
            ...
            <a href="https://wa.me/919876543210" target="_blank" rel="noreferrer" className="text-sm text-[#F5C84C] hover:underline">Chat with us</a>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6" data-testid="contact-office-card">
            ...
            <h3 className="text-sm font-bold text-[#111111] mb-1">Office</h3>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 sm:p-8">
          <h2 className="text-lg font-bold text-[#111111] mb-1">Send us a message</h2>
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Thank you! We will get back to you soon.'); }}>
            <div className="grid sm:grid-cols-2 gap-4">
              <input type="text" placeholder="Your Name" required className="w-full px-4 py-3 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-[#111111]" data-testid="contact-name-input" />
              <input type="email" placeholder="Your Email" required className="w-full px-4 py-3 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-[#111111]" data-testid="contact-email-input" />
            </div>
            ...
            <button type="submit" className="px-6 py-3 rounded-lg bg-[#F5C84C] text-white text-sm font-semibold hover:bg-[#B5912F] transition-colors" data-testid="contact-submit-btn">
              Send Message
            </button>
          </form>
        </div>
