  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (redirectTo) {
        ...
        const roleDashboards = { admin: '/admin/dashboard', rm: '/rm/dashboard', hr: '/hr/dashboard', venue_owner: '/venue-owner/dashboard', event_planner: '/planner/dashboard', finance: '/hr/dashboard', operations: '/hr/dashboard', marketing: '/hr/dashboard', customer: '/my-enquiries' };
