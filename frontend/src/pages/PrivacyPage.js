  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 py-12 sm:py-16" data-testid="privacy-content">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#0A1A2F] mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none text-[#374151] space-y-6">
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">5. Cookies & Tracking</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">6. Your Rights</h2>
            <p className="text-sm leading-relaxed text-[#64748B]">You have the right to access, correct, or delete your personal data. You may also opt out of marketing communications at any time. To exercise these rights, contact us at privacy@bookmyvenue.in.</p>
          </section>

          <section>
            <h2 className="text-base font-bold text-[#0A1A2F] mb-2">7. Contact</h2>
            <p className="text-sm leading-relaxed text-[#64748B]">For privacy-related inquiries, please contact us at privacy@bookmyvenue.in or through our Contact page.</p>
          </section>
        </div>
      </div>
    </div>
