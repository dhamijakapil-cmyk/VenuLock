  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-wider">Shared Comparison</span>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Shared notice */}
        <div className="mb-6 bg-[#FDFBF5] border border-[#D4AF37]/20 rounded-xl p-4 flex items-center gap-3" data-testid="shared-notice">
          <Share2 className="w-5 h-5 text-[#D4AF37] flex-shrink-0" />
          <p className="text-sm text-[#64748B]">
            Someone shared this venue comparison with you. <Link to="/venues/search" className="text-[#D4AF37] font-medium hover:underline">Start your own search</Link> to find your perfect venue.
          </p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                ...
                <CompareRow label="Rating" values={venues.map((v) => <span className="inline-flex items-center gap-1"><Star className="w-3.5 h-3.5 fill-[#D4AF37] text-[#D4AF37]" />{v.rating?.toFixed(1) || '—'}</span>)} />
                <tr>
        ...
        <div className="mt-8 text-center bg-white rounded-xl border border-slate-100 p-8">
          ...
          <div className="flex items-center justify-center gap-3">
            <button
              onClick={() => navigate('/venues/search')}
              className="bg-[#D4AF37] hover:bg-[#C4A030] text-[#111111] font-bold px-6 py-3 text-sm transition-colors flex items-center gap-2"
