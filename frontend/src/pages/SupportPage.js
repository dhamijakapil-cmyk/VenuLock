...
const FAQS = [
  { q: 'How does BookMyVenue work?', a: 'BookMyVenue is a managed booking platform. You tell us your event requirements, and our dedicated Relationship Manager finds, compares, and negotiates the best venue options for you.' },
  { q: 'Is there a fee for using the platform?', a: 'There is no fee for customers. BookMyVenue earns a commission from venues on confirmed bookings, so our service is completely free for you.' },
  ...
  { q: 'How do I list my venue on BookMyVenue?', a: 'Visit the "List Your Venue" page and submit your venue details. Our team will review your application within 2 business days.' },
];
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#0A1A2F] mb-2" data-testid="support-heading">Help & Support</h1>
        <p className="text-sm text-[#64748B] mb-10">Find answers to common questions or reach out to our team.</p>

        {/* Quick Actions */}
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          <a href="mailto:support@bookmyvenue.in" className="bg-white rounded-xl border border-slate-200 p-5 hover:border-[#C7A14A] transition-colors text-center" data-testid="support-email-action">
            <Mail className="w-6 h-6 text-[#C7A14A] mx-auto mb-2" />
            <h3 className="text-sm font-bold text-[#0A1A2F]">Email Support</h3>
            <p className="text-xs text-[#64748B] mt-1">support@bookmyvenue.in</p>
          </a>
          <a href="tel:+919876543210" className="bg-white rounded-xl border border-slate-200 p-5 hover:border-[#C7A14A] transition-colors text-center" data-testid="support-phone-action">
            <Phone className="w-6 h-6 text-[#0A1A2F] mx-auto mb-2" />
            <h3 className="text-sm font-bold text-[#0A1A2F]">Call Us</h3>
          ...
          <a href="https://wa.me/919876543210" target="_blank" rel="noreferrer" className="bg-white rounded-xl border border-slate-200 p-5 hover:border-emerald-400 transition-colors text-center" data-testid="support-whatsapp-action">
            ...
            <h3 className="text-sm font-bold text-[#0A1A2F]">WhatsApp</h3>
            <p className="text-xs text-[#64748B] mt-1">Quick chat support</p>
          </a>
        </div>

        {/* FAQ */}
        <h2 className="text-lg font-bold text-[#0A1A2F] mb-4">Frequently Asked Questions</h2>
        <div className="space-y-2" data-testid="faq-list">
          {FAQS.map((faq, i) => (
            <div key={i} className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              >
                <span className="text-sm font-semibold text-[#0A1A2F] pr-4">{faq.q}</span>
