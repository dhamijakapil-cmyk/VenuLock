          ...
          <div className="px-5 py-4">
            <div className="flex items-start justify-between">
              ...
              <a
                ...
                className="text-xs font-medium text-[#111111] hover:text-[#D4B36A] flex items-center gap-1 shrink-0"
              >
        ...
        <div className="bg-white border border-slate-200 p-5 hover:shadow-md transition-shadow" data-testid="metric-commission">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-[#D4B36A] mt-2 font-mono">
            ...
            <div className="w-10 h-10 bg-gradient-to-br from-[#D4B36A] to-[#D4B36A] flex items-center justify-center rounded-lg">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4 text-xs">
            ...
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-sm bg-[#D4B36A]" />
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <Badge className={`text-xs ${
                        venue.tier === 'Premium' ? 'bg-gradient-to-r from-[#D4B36A] to-[#D4B36A] text-[#111111] border-0' :
                    ...
                    <td className="px-4 py-4 text-right">
                      <p className="font-mono font-semibold text-[#D4B36A]">
