    ...
    <div className="min-h-screen bg-white text-[#1C1C1C] overflow-x-hidden">
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-[#F5C84C] text-white rounded-full hover:bg-[#B5912F] transition-all shadow-sm"
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F5F0E5] border border-[#E8DCC8] mb-8">
                <Activity className="h-4 w-4 text-[#F5C84C]" />
              ...
              <p
                className="font-serif text-xl sm:text-2xl italic text-[#F5C84C] mb-6"
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                {[
                  ...
                  >
                    <item.icon className="h-4 w-4 text-[#F5C84C]" />
              ...
              <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-lg shadow-black/[0.04] p-2 flex gap-2" data-testid="city-search-panel">
                <div className="relative flex-1">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-3 py-3.5 rounded-xl bg-[#F9FAFB] text-sm focus:outline-none focus:ring-2 focus:ring-[#F5C84C]/30 appearance-none cursor-pointer text-[#1C1C1C]"
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#F5C84C] text-white font-medium hover:bg-[#B5912F] transition-all group whitespace-nowrap"
              ...
              <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-lg shadow-black/[0.04] p-4 space-y-3" data-testid="nearby-search-panel">
                {geoLoading && (
                  <div className="flex items-center gap-2 text-sm text-[#6B7280] py-1">
                    <Loader2 className="h-4 w-4 animate-spin text-[#F5C84C]" />
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#F9FAFB] text-sm focus:outline-none focus:ring-2 focus:ring-[#F5C84C]/30 appearance-none cursor-pointer"
                  ...
                  <div className="flex items-end">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#F5C84C] text-white font-medium hover:bg-[#B5912F] transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
                ...
                {!geoCoords && !geoLoading && !geoError && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-dashed border-[#F5C84C]/40 text-sm text-[#F5C84C] hover:bg-[#F5C84C]/5 transition-colors"
            ...
            {LIVE_STATS.map((stat) => (
              ...
              >
                <div className="inline-flex h-12 w-12 rounded-xl bg-[#F5F0E5] items-center justify-center mb-4">
                  <stat.icon className="h-5 w-5 text-[#F5C84C]" />
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-10">
            {HOW_IT_WORKS.map((item, index) => (
              <div key={item.step} className="relative text-center group">
                {/* Step number */}
                <div className="inline-flex items-center justify-center h-14 w-14 rounded-2xl bg-[#1C1C1C] text-white text-lg font-bold mb-6 group-hover:bg-[#F5C84C] transition-colors duration-300">
                  {item.step}
                </div>
      ...
      <section id="cities" className="py-16 sm:py-24 bg-[#FAFAF8]" data-testid="explore-by-city">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
            ...
            <button
              onClick={() => navigate('/venues/search')}
              className="inline-flex items-center gap-1 text-sm font-medium text-[#F5C84C] hover:text-[#B5912F] transition-colors group"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {PLATFORM_ADVANTAGES.map((advantage) => (
              <div
                key={advantage.title}
                className="bg-[#FAFAF8] rounded-2xl border border-[#F0F0F0] p-6 hover:shadow-lg hover:shadow-black/[0.04] hover:border-[#F5C84C]/20 transition-all duration-300 group"
                data-testid={`advantage-card`}
              >
                <div className="h-12 w-12 rounded-xl bg-[#F5F0E5] flex items-center justify-center mb-5 group-hover:bg-[#F5C84C]/15 transition-colors">
                  <advantage.icon className="h-5 w-5 text-[#F5C84C]" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="relative rounded-3xl overflow-hidden bg-[#1C1C1C] p-8 sm:p-10 text-white">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#F5C84C]/8 rounded-full blur-[100px]" />
              <div className="relative">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/10 mb-6">
                  <Building2 className="h-4 w-4 text-[#F5C84C]" />
                ...
                <button
                  onClick={() => navigate('/register')}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#F5C84C] text-white font-medium hover:bg-[#B5912F] transition-all group"
            ...
            <div className="relative rounded-3xl overflow-hidden bg-[#F5F0E5] p-8 sm:p-10">
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#F5C84C]/8 rounded-full blur-[100px]" />
              <div className="relative">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F5C84C]/10 border border-[#F5C84C]/20 mb-6">
                  <Headphones className="h-4 w-4 text-[#F5C84C]" />
      ...
      <section className="py-20 sm:py-28 bg-[#1C1C1C] text-white" data-testid="final-cta">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-serif text-xl sm:text-2xl italic text-[#F5C84C] mb-4">
            We Negotiate. You Celebrate.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() => navigate('/venues/search')}
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#F5C84C] text-white font-semibold hover:bg-[#B5912F] transition-all group"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="font-serif text-sm italic text-[#F5C84C]">
                We Negotiate. You Celebrate.
              </p>
            </div>
